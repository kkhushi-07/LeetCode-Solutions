# LeetCode Solutions 🚀
BCA Student | DSA Practice | Daily Problem Solving
...
| 3345 | [Smallest Divisible Digit Product I](https://leetcode.com/problems/smallest-divisible-digit-product-i/) | [C++](./Arrays/3345_smallest_divisible_digit_product_i.cpp) | Easy | O(k · log₁₀n) | O(1) | Math, Simulation |
| 1 | [Two Sum](https://leetcode.com/problems/two-sum/) | [C++](./Arrays/0001-two-sum.cpp) | Easy | O(n) | O(n) | Hash Map, Complement Search |
...
| 162 | [Find Peak Element](https://leetcode.com/problems/find-peak-element/) | [C++](./Arrays/0162-find-peak-element.cpp) | Medium | O(log n) | O(1) | Binary Search on Slope |
...
| 33 | [Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [C++](./Arrays/0033-search-in-rotated-sorted-array.cpp) | Medium | O(log n) | O(1) | Modified Binary Search, Rotated Array |
...
| 191 | Number of 1 Bits | [C++](./Bit_Manipulation/0191-number-of-1-bits.cpp) | Easy | O(1) | O(1) | Bit Manipulation |
